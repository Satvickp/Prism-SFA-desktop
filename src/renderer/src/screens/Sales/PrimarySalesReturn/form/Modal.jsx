...
import "./index.css";
import { getAllClients } from "../../../../api/clients/clientfmcg-api";
...
function PrimarySalesModal({ handleIsModal, isOpen, isPrimary }) {
  ...
  const loadClient = useCallback(
    async (page) => {
      ...
      try {
        let resp = await getAllClients(Cred.token, 0, Cred.sub);
        if (page <= 0) {
          dispatch(
            setClientsFMCG({
          ...
          <div className="my-2 mx-2">
            ...
            <div className="table-footer m-2">
              <div className="d-flex justify-content-start align-items-center">
                ...
                <span className="ms-2">₹ {Cred.topUpBalance?.toFixed(2)}</span>
              </div>
