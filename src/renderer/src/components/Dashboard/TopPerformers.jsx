  ...
  return (
    <div className="card light-danger-bg">
      <div className="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
        <h6 className="mb-0 fw-bold ">Employee Performance</h6>
      </div>
      <div className="card-body">
        <div className="row g-3 align-items-center">
          ...
          <div className="col-md-8 col-lg-8 col-xl-8 col-xxl-10">
            <div className="row g-3 row-cols-2 row-cols-sm-3 row-cols-md-3 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-3 row-deck top-perfomer">
              <div className="col">
